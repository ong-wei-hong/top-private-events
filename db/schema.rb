...
ActiveRecord::Schema.define(version: 2021_09_20_005450) do
  ...
  create_table "event_invites", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["invited_event_id"], name: "index_event_invites_on_invited_event_id"
  ...
  add_foreign_key "event_invites", "events", column: "invited_event_id"
